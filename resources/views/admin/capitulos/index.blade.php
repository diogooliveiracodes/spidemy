            ...
            <div class="card border-left-secondary shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col">
                            <form action="{{route('admin.capitulos.delete', ['capitulo' => $capitulo])}}" method="POST">
                                @csrf
                                @method('delete')
        ...
        <div class="col-xl-12 col-md-12 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <form action="{{route('admin.capitulos.store', ['curso'=>$curso])}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
