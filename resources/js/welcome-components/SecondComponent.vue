                    ...
                    <div class="col-lg-8 text-center">
                        ...
                        <div class="row mx-0 px-0 text-left">
                            <div class="row mx-0 px-0 align-items-center">
                                <i class="fas fa-tablet-alt fa-5x text-primary"></i>
                                <div>
                        ...
                        <div class="row mx-0 px-0 text-left">
                            <div class="row mx-0 px-0 mt-4 align-items-center">
                                <i class="far fa-clock fa-5x text-success"></i>
                                <div>
                        ...
                        <div class="row mx-0 px-0 text-left">
                            <div class="row mx-0 px-0 mt-4 align-items-center">
                                <i class="fas fa-search-dollar fa-5x text-warning"></i>
                                <div>
                                    <h3 class="text-warning ml-4 text-left align-items-center">Valor acessível</h3>
                                </div>
                                <p class="lead text-muted text-justify">
                        ...
                        <div class="btn-wrapper">
                            <a href="https://www.creative-tim.com/product/vue-argon-design-system"
                               class="btn btn-primary btn-lg my-3 mb-sm-0" style="background: #0084ff !important; border: none; border-radius: 20px;">Quero começar!</a>
                        </div>
                    </div>
                </div>
            </div>
